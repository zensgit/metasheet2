...
const P25_CALL_PATH_CLASSIFICATIONS = Object.freeze([
  ...
  entry('plugins/plugin-attendance/index.cjs', 'approvedOvertimeWindows', 'attendance_import_jobs', 'read', 'select', 2, 'operational_status', 'legacy_plugin_compatibility'),
  entry('plugins/plugin-attendance/index.cjs', 'approvedOvertimeWindows', 'attendance_import_upload_cleanup_commands', 'read', 'select', 1, 'operational_status', 'upload_cleanup_worker'),
