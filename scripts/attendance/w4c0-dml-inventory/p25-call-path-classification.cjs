...
const P25_CALL_PATH_CLASSIFICATIONS = Object.freeze([
  ...
  entry('plugins/plugin-attendance/index.cjs', 'processAsyncImportCommitJob', 'attendance_import_jobs', 'write', 'update', 1, 'operational_status', 'legacy_async_worker'),
  entry('plugins/plugin-attendance/index.cjs', 'onProgress', 'attendance_import_jobs', 'write', 'update', 1, 'operational_status', 'legacy_async_worker'),
  entry('plugins/plugin-attendance/index.cjs', 'dataTypeFor', 'attendance_import_jobs', 'read', 'select', 2, 'operational_status', 'legacy_plugin_compatibility'),
  entry('plugins/plugin-attendance/index.cjs', 'dataTypeFor', 'attendance_import_upload_cleanup_commands', 'read', 'select', 1, 'operational_status', 'upload_cleanup_worker'),
  ...
  entry('plugins/plugin-attendance/index.cjs', 'dataTypeFor', 'attendance_import_jobs', 'write', 'insert', 2, 'operational_status', 'legacy_plugin_compatibility'),
  ...
  entry('plugins/plugin-attendance/index.cjs', 'dataTypeFor', 'attendance_integrations', 'write', 'update', 3, 'configuration_maintenance', 'integration_configuration'),
