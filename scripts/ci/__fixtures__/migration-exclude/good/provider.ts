// Fixture standing in for packages/core-backend/src/db/migration-provider.ts. See
// docs/development/migration-legacy-sql-skip-design-20260512.md for the real design doc this
// pointer check looks for.
