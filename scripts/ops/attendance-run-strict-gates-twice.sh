...
info "Strict gates: admin_api=${REQUIRE_ATTENDANCE_ADMIN_API} idempotency=${REQUIRE_IDEMPOTENCY} import_export=${REQUIRE_IMPORT_EXPORT} import_async=${REQUIRE_IMPORT_ASYNC} batch_resolve=${REQUIRE_BATCH_RESOLVE}"
