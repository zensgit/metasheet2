...
REQUIRE_IMPORT_UPSERT_STRATEGY="${REQUIRE_IMPORT_UPSERT_STRATEGY:-true}"
...
info "Strict gates: admin_api=${REQUIRE_ATTENDANCE_ADMIN_API} idempotency=${REQUIRE_IDEMPOTENCY} import_export=${REQUIRE_IMPORT_EXPORT} import_upload=${REQUIRE_IMPORT_UPLOAD} import_async=${REQUIRE_IMPORT_ASYNC} import_upload_async=${REQUIRE_IMPORT_UPLOAD_ASYNC} import_telemetry=${REQUIRE_IMPORT_TELEMETRY} import_upsert_strategy=${REQUIRE_IMPORT_UPSERT_STRATEGY} preview_async=${REQUIRE_PREVIEW_ASYNC} batch_resolve=${REQUIRE_BATCH_RESOLVE} import_job_recovery=${REQUIRE_IMPORT_JOB_RECOVERY} admin_settings_save=${REQUIRE_ADMIN_SETTINGS_SAVE}"
...
ATTENDANCE_SYNTHETIC_ORG_ID="${ATTENDANCE_SYNTHETIC_ORG_ID:-}" \
ORG_ID="${ORG_ID:-}" \
AUTH_EXPECTED_TENANT_ID="${AUTH_EXPECTED_TENANT_ID:-}" \
ATTENDANCE_EXPECTED_DEPLOY_SHA="${ATTENDANCE_EXPECTED_DEPLOY_SHA:-}" \
OUTPUT_ROOT="$out1" \
