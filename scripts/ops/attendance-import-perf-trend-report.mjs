 ...
 *
 * Produces Markdown + JSON report for 10k/50k/100k daily regression runs.
 */
...
function renderMarkdown(payload) {
  ...
  lines.push('- 50k/100k scenarios are expected to run `preview` checks for daily scale trend.')
