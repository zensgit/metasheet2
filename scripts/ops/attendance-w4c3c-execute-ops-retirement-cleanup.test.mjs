...
test('P15 source: inventory SQL includes W4-backed filter predicates', async () => {
  ...
  assert.match(source, /current_calculation_version/)
  assert.match(source, /latest_calculation_id/)
  assert.match(source, /latest_calculation_version/)
  assert.match(source, /expectedCalculationId/)
  assert.match(source, /expectedCalculationVersion/)
