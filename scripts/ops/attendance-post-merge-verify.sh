...
REQUIRED_CHECKS_CSV="${REQUIRED_CHECKS_CSV:-contracts (strict),contracts (dashboard),pr-validate,test (20.x),contracts (openapi)}"
...
LOCALE_ZH_WEB_URL="${LOCALE_ZH_WEB_URL:-http://23.254.236.11:8081}"
