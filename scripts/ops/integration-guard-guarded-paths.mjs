...
export const GUARDED_PATH_ENTRIES = Object.freeze([
  ...
  'apps/web/src/services/integration/monitoringQuery.ts',
  ...
  'apps/web/tests/integrationMonitoringQuery.spec.ts',
  'apps/web/tests/integrationMonitoringReach.spec.ts',
