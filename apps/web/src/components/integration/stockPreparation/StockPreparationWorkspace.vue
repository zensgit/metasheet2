...
const views: StockPreparationViewTab[] = [
  ...
  // rail item (设计稿 §2.2). Same tier and same component as 数据来源与体检 below.
  {
    ...
    zh: '开始使用',
    en: 'Getting Started',
    zhDesc: '第一次接入,按顺序走完这七步,一线就能开始用了。任何一步都能点开看 —— 这是一张地图,不是一道闸机。',
    enDesc: 'Setting up for the first time: seven steps, in order, and the floor can start using it. Every step opens — this is a map, not a turnstile.',
