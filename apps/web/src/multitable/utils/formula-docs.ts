...
export const FORMULA_FUNCTION_DOCS: FormulaFunctionDoc[] = [
  ...
  // ── Cluster-C path-1 batch 1: 13 standard scalar functions — math (PRODUCT/SIGN/PI/RADIANS/DEGREES/
  // GCD/LCM), text (VALUE/PROPER/TEXTJOIN), statistical (STDEVP/VARP population variants), and
  // lookup (CHOOSE). All are pure-scalar/variadic-scalar (no range/array semantics). ──
  {
    name: 'PRODUCT',
    signature: 'PRODUCT(number, ...)',
    category: 'aggregate',
    description: 'Multiplies numeric values together.',
    example: '=PRODUCT({fld_quantity}, {fld_unit_price})',
    insertText: 'PRODUCT()',
  },
  {
    name: 'SIGN',
    ...
    category: 'math',
    description: 'Returns 1, -1, or 0 depending on whether a number is positive, negative, or zero.',
    example: '=SIGN({fld_delta})',
    insertText: 'SIGN()',
  },
  {
    name: 'PI',
  ...
  },
  {
    ...
    example: '=DEGREES({fld_angle_rad})',
    insertText: 'DEGREES()',
  },
  {
    name: 'GCD',
    signature: 'GCD(number, ...)',
    category: 'math',
    description: 'Returns the greatest common divisor of the given integers.',
    example: '=GCD({fld_a}, {fld_b})',
    insertText: 'GCD()',
  },
  {
    name: 'LCM',
    signature: 'LCM(number, ...)',
    category: 'math',
    description: 'Returns the least common multiple of the given integers.',
    example: '=LCM({fld_a}, {fld_b})',
    insertText: 'LCM()',
  },
  {
    name: 'VALUE',
    ...
    category: 'text',
    description: 'Converts text that looks like a number into a number.',
    example: '=VALUE({fld_amount_text})',
    insertText: 'VALUE()',
  },
  {
    name: 'PROPER',
    ...
    example: '=PROPER({fld_name})',
    insertText: 'PROPER()',
  },
  {
    name: 'TEXTJOIN',
    signature: 'TEXTJOIN(delimiter, ignore_empty, text, ...)',
    category: 'text',
    description: 'Joins text values with a delimiter, optionally skipping empty values.',
    example: '=TEXTJOIN(", ", TRUE(), {fld_city}, {fld_state})',
    insertText: 'TEXTJOIN(, , )',
  },
  {
    name: 'STDEVP',
    signature: 'STDEVP(number, ...)',
    category: 'statistical',
    description: 'Returns the population standard deviation of numeric values.',
    example: '=STDEVP({fld_score_1}, {fld_score_2})',
    insertText: 'STDEVP()',
  },
  {
    name: 'VARP',
    signature: 'VARP(number, ...)',
    category: 'statistical',
    description: 'Returns the population variance of numeric values.',
    example: '=VARP({fld_score_1}, {fld_score_2})',
    insertText: 'VARP()',
  },
  {
    name: 'CHOOSE',
    signature: 'CHOOSE(index, value1, ...)',
    category: 'lookup',
  ...
  // XOR), math (directional rounding), and date (weekday, second, month-shift, day-diff). ──
  {
    ...
    category: 'logic',
    description: 'Returns a fallback value when the given value is an error, otherwise returns the value unchanged.',
    example: '=IFERROR({fld_ratio}, 0)',
    insertText: 'IFERROR(, )',
  },
  {
    name: 'ISERROR',
    ...
    category: 'logic',
    description: 'Returns true when the given value is an error result.',
    example: '=ISERROR({fld_ratio})',
    insertText: 'ISERROR()',
  },
  {
    name: 'ISBLANK',
    ...
    category: 'logic',
    description: 'Returns true when the value is empty (null, undefined, or an empty string).',
    example: '=ISBLANK({fld_notes})',
    insertText: 'ISBLANK()',
  },
  {
    name: 'ISNUMBER',
    ...
    category: 'logic',
    description: 'Returns true when the value is a valid number.',
    example: '=ISNUMBER({fld_amount})',
    insertText: 'ISNUMBER()',
  },
  {
    name: 'IFS',
    signature: 'IFS(condition, value, ...)',
    category: 'logic',
    description: 'Evaluates condition/value pairs in order and returns the value for the first true condition; returns #N/A if none match.',
    example: '=IFS({fld_score} >= 90, "A", {fld_score} >= 80, "B", TRUE, "C")',
    insertText: 'IFS(, )',
  },
  {
    name: 'XOR',
    signature: 'XOR(value, ...)',
    category: 'logic',
    description: 'Returns true when an odd number of the given values are truthy (exclusive OR).',
    example: '=XOR({fld_flag_a}, {fld_flag_b})',
    insertText: 'XOR()',
  },
  {
    name: 'ROUNDUP',
    ...
    category: 'math',
    description: 'Rounds a number up, away from zero, to the requested decimal places.',
    example: '=ROUNDUP({fld_amount}, 2)',
    insertText: 'ROUNDUP(, 2)',
  },
  {
    name: 'ROUNDDOWN',
    signature: 'ROUNDDOWN(number, [digits])',
    category: 'math',
    description: 'Rounds a number down, toward zero, to the requested decimal places.',
    example: '=ROUNDDOWN({fld_amount}, 2)',
    insertText: 'ROUNDDOWN(, 2)',
  },
  {
    name: 'WEEKDAY',
    signature: 'WEEKDAY(date, [type])',
    category: 'date',
    description: 'Returns the day of the week as a number; by default Sunday=1…Saturday=7, or use type 2 for a Monday-start week (Monday=1…Sunday=7).',
    example: '=WEEKDAY({fld_due_date})',
    insertText: 'WEEKDAY()',
  },
  {
    name: 'SECOND',
    ...
    category: 'date',
    description: 'Returns the second (0–59) of a date-time value.',
    example: '=SECOND({fld_logged_at})',
    insertText: 'SECOND()',
  },
  {
    name: 'EDATE',
    ...
    category: 'date',
    description: 'Returns the date shifted by whole months, clamped to the end of the target month.',
    example: '=EDATE({fld_invoice_date}, 1)',
    insertText: 'EDATE()',
  },
  {
    name: 'DAYS',
    ...
    category: 'date',
    description: 'Returns the number of calendar days between two dates (end date minus start date).',
    example: '=DAYS({fld_due_date}, {fld_start_date})',
    insertText: 'DAYS(, )',
  },
  // ── Cluster-C path-1 batch 2: 26 standard scalar functions — trig/math, numeric predicates, text,
  // and date/time. All pure-scalar (no range/array semantics). ──
  {
    name: 'SIN',
    signature: 'SIN(number)',
    category: 'math',
    description: 'Returns the sine of an angle given in radians.',
    example: '=SIN({fld_angle_rad})',
    insertText: 'SIN()',
  },
  {
    name: 'COS',
  ...
  },
  {
    ...
    category: 'math',
    description: 'Returns the arcsine (in radians) of a number between -1 and 1.',
    example: '=ASIN({fld_ratio})',
    insertText: 'ASIN()',
  },
  {
    name: 'ACOS',
    ...
    category: 'math',
    description: 'Returns the arccosine (in radians) of a number between -1 and 1.',
    example: '=ACOS({fld_ratio})',
    insertText: 'ACOS()',
  },
  {
    name: 'ATAN',
  ...
  },
  {
    ...
    category: 'math',
    description: 'Returns the arctangent (in radians) of the specified x and y coordinates.',
    example: '=ATAN2({fld_x}, {fld_y})',
    insertText: 'ATAN2(, )',
  },
  {
    name: 'LOG10',
  ...
  },
  {
    ...
    category: 'math',
    description: 'Returns the integer portion of a division, truncated toward zero.',
    example: '=QUOTIENT({fld_total}, {fld_batch_size})',
    insertText: 'QUOTIENT(, )',
  },
  {
    name: 'MROUND',
  ...
  },
  {
    ...
    category: 'text',
    description: 'Compares two text values and returns true only for an exact, case-sensitive match.',
    example: '=EXACT({fld_code}, {fld_confirm_code})',
    insertText: 'EXACT(, )',
  },
  {
    name: 'CHAR',
    ...
    category: 'text',
    description: 'Returns the character for a given character code (1-255).',
    example: '=CHAR({fld_code})',
    insertText: 'CHAR()',
  },
  {
    name: 'CODE',
    signature: 'CODE(text)',
    category: 'text',
    description: 'Returns the character code of the first character in a text value.',
    example: '=CODE({fld_symbol})',
    insertText: 'CODE()',
  },
  {
    name: 'CLEAN',
    ...
    example: '=CLEAN({fld_imported_notes})',
    insertText: 'CLEAN()',
  },
  {
    name: 'ISTEXT',
  ...
  },
  {
    ...
    category: 'date',
    description: 'Converts a date stored as text into a date value.',
    example: '=DATEVALUE({fld_date_text})',
    insertText: 'DATEVALUE()',
  },
  {
    name: 'TIMEVALUE',
    signature: 'TIMEVALUE(text)',
    category: 'date',
    description: 'Converts a time stored as "HH:MM" or "HH:MM:SS" text into a time value.',
    example: '=TIMEVALUE({fld_time_text})',
  ...
  },
  {
    ...
    category: 'date',
    description: 'Builds a time value from hour, minute, and second numbers.',
    example: '=TIME({fld_hour}, {fld_minute}, {fld_second})',
    insertText: 'TIME(, , )',
  },
  {
    name: 'ISOWEEKNUM',
    ...
    category: 'date',
    description: 'Returns the ISO-8601 week number of a date (weeks start Monday; week 1 holds the first Thursday of the year).',
    example: '=ISOWEEKNUM({fld_date})',
    insertText: 'ISOWEEKNUM()',
  },
  {
    name: 'YEARFRAC',
    signature: 'YEARFRAC(start_date, end_date, [basis])',
    category: 'date',
    description: 'Returns the fraction of a year between two dates, using the US (NASD) 30/360 method (basis 0; other basis values are not supported).',
    example: '=YEARFRAC({fld_start_date}, {fld_end_date}, 0)',
    insertText: 'YEARFRAC(, , 0)',
  },
  {
    name: 'NETWORKDAYS',
    signature: 'NETWORKDAYS(start_date, end_date)',
    category: 'date',
    description: 'Counts working days (Monday-Friday, inclusive of both dates) between two dates. Holiday exclusion is not supported.',
    example: '=NETWORKDAYS({fld_start_date}, {fld_due_date})',
    insertText: 'NETWORKDAYS(, )',
  },
]
...
const FORMULA_FUNCTION_ARITY: Record<string, Pick<FormulaFunctionDoc, 'minArgs' | 'maxArgs'>> = {
  ...
  CHAR: { minArgs: 1, maxArgs: 1 },
  CHOOSE: { minArgs: 2 },
  CLEAN: { minArgs: 1, maxArgs: 1 },
  CODE: { minArgs: 1, maxArgs: 1 },
  CONCAT: { minArgs: 1 },
  ...
  DATEVALUE: { minArgs: 1, maxArgs: 1 },
  DAY: { minArgs: 1, maxArgs: 1 },
  DAYS: { minArgs: 2, maxArgs: 2 },
  DEGREES: { minArgs: 1, maxArgs: 1 },
  EDATE: { minArgs: 1, maxArgs: 2 },
  EVEN: { minArgs: 1, maxArgs: 1 },
  EXACT: { minArgs: 2, maxArgs: 2 },
  FACT: { minArgs: 1, maxArgs: 1 },
  ...
  ISBLANK: { minArgs: 1, maxArgs: 1 },
  ISERROR: { minArgs: 1, maxArgs: 1 },
  ISEVEN: { minArgs: 1, maxArgs: 1 },
  ISNUMBER: { minArgs: 1, maxArgs: 1 },
  ISODD: { minArgs: 1, maxArgs: 1 },
  ISOWEEKNUM: { minArgs: 1, maxArgs: 1 },
  ...
  MROUND: { minArgs: 2, maxArgs: 2 },
  NETWORKDAYS: { minArgs: 2, maxArgs: 2 },
  NOT: { minArgs: 1, maxArgs: 1 },
  NOW: { minArgs: 0, maxArgs: 0 },
  ODD: { minArgs: 1, maxArgs: 1 },
  OR: { minArgs: 1 },
  PI: { minArgs: 0, maxArgs: 0 },
  POWER: { minArgs: 2, maxArgs: 2 },
  PRODUCT: { minArgs: 1 },
  PROPER: { minArgs: 1, maxArgs: 1 },
  QUOTIENT: { minArgs: 2, maxArgs: 2 },
