...
export const FORMULA_FUNCTION_DOCS: FormulaFunctionDoc[] = [
  ...
  },
  {
    ...
    category: 'logic',
    description: 'Evaluates condition/value pairs in order and returns the value for the first true condition.',
  ...
  },
  {
    ...
    category: 'date',
    description: 'Returns the day of the week as a number; use type 2 for a Monday-start week.',
