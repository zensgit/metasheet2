...
const LABELS: Record<MetaPermissionLabelKey, { en: string; zh: string }> = {
  ...
  'rowDeny.toggle': { en: 'Enable per-record read-deny for this sheet', zh: '为此数据表启用按记录的读取拒绝' },
  ...
  'rowDeny.noneHint': { en: 'Only effective when row-level read permissions are enabled for this sheet.', zh: '仅当此数据表启用了行级读取权限时生效。' },
  'rowDeny.enabledNote': { en: 'Row-level read-deny is ON for this sheet.', zh: '此数据表已开启行级读取拒绝。' },
  ...
  'field.noSubjects': {
    ...
    zh: '暂无拥有数据表访问权限的对象。请先授予数据表访问权限，再配置字段权限。',
  },
  ...
  'permission.noCurrentSheetAccess': { en: 'No current sheet access', zh: '当前无数据表访问权限' },
  ...
  'sheet.emptyAccess': { en: 'No sheet-specific access grants yet.', zh: '暂无数据表专属访问授权。' },
  ...
  'sheet.error.loadAccess': { en: 'Failed to load sheet access', zh: '加载数据表访问权限失败' },
  'sheet.error.loadCandidates': { en: 'Failed to load permission candidates', zh: '加载权限候选项失败' },
  'sheet.error.updateAccess': { en: 'Failed to update sheet access', zh: '更新数据表访问权限失败' },
  ...
  'sheet.status.removed': { en: 'Sheet access override removed', zh: '数据表访问覆盖已移除' },
  'sheet.status.saved': { en: 'Sheet access override saved', zh: '数据表访问覆盖已保存' },
  'sheet.status.updated': { en: 'Sheet access override updated', zh: '数据表访问覆盖已更新' },
  'sheet.subtitle': {
    ...
    zh: '为可授权人员、成员组或角色覆盖数据表级访问权限。管理员包含分享和删除数据表权限；仅写入自己仍只适用于用户。',
  },
  'sheet.tab.fields': { en: 'Field Permissions', zh: '字段权限' },
  'sheet.tab.sheet': { en: 'Sheet Access', zh: '数据表访问权限' },
  ...
  'view.noSubjects': {
    ...
    zh: '暂无拥有数据表访问权限的对象。请先授予数据表访问权限，再配置视图权限。',
  },
