<!--
  UI-P2-2a (design-lock multitable-ui-p2-2-left-rail-detail-designlock-20260707.md §5): this
  component's tab logic has been extracted verbatim into MetaSheetViewRail.vue, which is now the
  sole production consumer's (MultitableWorkbench.vue) mount point. This file is intentionally
  RETAINED — unused by production code, still covered by tests/meta-view-tab-bar-personal-toggle.spec.ts
  — as the frozen pre-extraction baseline that tests/meta-sheet-view-rail.spec.ts diffs the new
  component against to prove byte-for-byte DOM equivalence. Do not edit this file's template/script/
  style; any change here invalidates the equivalence proof. Slated for removal once P2-2b lands and
  the baseline is no longer needed.
-->
<template>
