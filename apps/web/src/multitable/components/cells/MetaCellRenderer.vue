...
button.meta-cell-renderer__link--clickable:hover { background: rgba(37, 99, 235, 0.22); }
...
.meta-cell-renderer--positive { color: #3d7a45; }
.meta-cell-renderer--negative { color: #b45353; }
...
.meta-cell-renderer__person-chip {
  ...
  margin-right: 4px;
  background: rgba(34, 116, 71, 0.14);
  color: rgb(31, 62, 45);
  border-radius: 4px;
  font-size: 11px;
  font-weight: 500;
...
.meta-cell-renderer__person-avatar {
  ...
  height: 14px;
  border-radius: 50%;
  background: rgba(34, 116, 71, 0.22);
  color: rgb(31, 62, 45);
  font-size: 10px;
  font-weight: 500;
  line-height: 1;
