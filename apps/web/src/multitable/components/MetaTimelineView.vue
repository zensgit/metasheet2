...
.meta-timeline__placeholder-action { padding: 8px 12px; border: 1px solid #c7ddff; border-radius: 6px; background: #ecf5ff; color: #2563eb; font-size: 12px; cursor: pointer; }
.meta-timeline__placeholder-action:hover { background: #dbeafe; }
.meta-timeline__header { display: flex; align-items: flex-end; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; height: 32px; }
.meta-timeline__label-col { width: 160px; min-width: 160px; font-size: 12px; font-weight: 600; color: #666; padding: 0 8px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: flex; flex-direction: column; gap: 1px; }
.meta-timeline__header-meta { font-size: 10px; font-weight: 400; color: #9ca3af; }
.meta-timeline__axis { flex: 1; position: relative; height: 20px; }
.meta-timeline__zoom-badge { position: absolute; right: 0; top: -18px; font-size: 10px; color: #409eff; background: #ecf5ff; border: 1px solid #d9ecff; border-radius: 999px; padding: 0 6px; line-height: 16px; }
...
.meta-timeline__row--dragging { background: #eff6ff; }
