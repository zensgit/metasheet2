<!--
  ...
  S3a (comments shared FE kit extraction, later slice): moved verbatim a second time, from
  multitable/components/MetaCommentsPanel.vue to here — same template, script, scoped styles,
  class names, emits, and testids (only import PATHS changed: useLocale/normalizeMultitableComment
