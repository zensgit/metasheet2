<!--
  ...
  multitable/components/MetaCommentReactions.vue — same template, script, scoped styles, class
  names, and testids. multitable/components/MetaCommentReactions.vue is now a re-export shim at
  the old path (kept only because multitable-comment-reactions.spec.ts imports it from there).
-->
<template>
