...
// multitable/utils/meta-comment-labels.ts, which now re-exports every name from here so its
// existing consumers (multitable views/composables, and this file's own frozen
// meta-comment-labels.spec.ts) keep working unchanged.
