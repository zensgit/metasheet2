...
describe('Attendance self-service dashboard', () => {
  ...
  it('renders self-service cards with status, request summaries, quick actions, and status guide', async () => {
    ...
    expect(container?.querySelector('[data-selfservice-card="rules"]')?.textContent).toContain('09:00-18:00 · UTC+08:00 · Asia/Shanghai')
    expect(container?.querySelector('[data-selfservice-card="rules"]')?.textContent).not.toContain('09:00-18:00 · Asia/Shanghai')
    ...
    expect(container?.textContent).toContain('Anomalies timezone context: UTC+08:00 · Asia/Shanghai')
