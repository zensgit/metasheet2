...
set -euo pipefail
cd "$(dirname "$0")/.."
npx vitest run approval-canvas-commands approval-canvas-c4-command-wiring approval-authoring-history approval-form-commands --reporter=dot
