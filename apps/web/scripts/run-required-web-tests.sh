...
# E-learning V0.1 (2026-08-25): four whole-file tokens as a distinct targeted
# invocation so a name filter matching zero tests cannot skip-green. Full paths
# avoid substring collisions with future sibling specs.
npx vitest run \
