...
**核对结果：状态账本 §4 没有这一条**（该节现有七项:V3 抽取债、~~`ext_` 守卫接线缺口~~(**已闭合**,
2026-09-10 复核)、`ext_` mapper 未接线、提案文档 stale、大 BOM 路径未接、迁移必须先做身份归一、本机
pin 重算不可信,`beiliao-takeover-status-ledger.md:96-102`。**2026-09-10 订正**:原文"六项"与行号
