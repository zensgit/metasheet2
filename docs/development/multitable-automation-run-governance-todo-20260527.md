...
- [ ] A6-4c Workflow Designer compile-preview UI — not started; must consume A6-4b read-only route, render mapping/gap reports, and keep no-live-runtime / no-persistence UI guards.
