...
| Lock-7 | server-enforced readonly/editable field semantics for a named edit surface | RATIFIED — `approval-lock7-field-edit-enforcement-20260817.md` §4 (2026-08-17, goal-set provenance; twelve ODs per document recommendations). **§2.7 D-5 (instance-detail read scope) is RESOLVED-BY Lock-10**; D-4 (no fourth participant predicate) is discharged by Lock-10's single-predicate ruling, whose implementation is blocked on the Lock-9 amendment recorded in Lock-10 §5.1 | owner |
...
| Lock-9 | approver-side process attachments: a standalone action-attachment carrier bound to the audit record, not a form field | RATIFIED — `approval-lock9-handler-process-attachments-20260819.md` §4 (2026-08-21, owner-directed execute-by-reference provenance; fourteen ODs per document recommendations). **Amendment PENDING:** its ratified OD-L9-13(a) ("reuse `isInstanceParticipant` UNCHANGED") and gate G-4 conflict with Lock-10's OD-S1-10/OD-S1-16; the decision is Lock-10 §5.1 row `L9-AMEND` and is owner-level | owner |
| Lock-10 | the per-instance readability predicate (S1): ONE admission gate for approval instance reads, its org anchor, and its three consumers — resolves Lock-7 §2.7 D-5 | RATIFIED — `approval-lock10-instance-readability-20260821.md` §4 (2026-08-21, owner-directed execute-by-reference provenance; eighteen ODs, OD-S1-1..18, recorded in three buckets — RATIFIED, session design authority, and OWNER-CONFIRM-before-implementation — after an independent adversarial review returned REQUEST-CHANGES at 3 P1 / 5 P2 / 6 P3 / 4 NIT, all closed or rebutted in §7). Five items remain blocking in its §5.1 (`L9-AMEND`, OD-S1-12, the OD-S1-7/C-2 metrics widening, OD-S1-17(c), OD-S1-8(d)) | owner |
