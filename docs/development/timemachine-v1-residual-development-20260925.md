...
| Synthetic checkpoint pool cleanup | A later main push at `4189aa096a8a8054315bb97db79dfbac1823954e` failed its first Node 20 attempt on immediate post-test `pg_stat_activity` residue (1 instead of 0); the second attempt passed. [#6059](https://github.com/zensgit/metasheet2/pull/6059) is a one-file test-harness drain fix. Prior head `974b945210cf1856b7bc1bba8335401f182abc7e` was green; current-main replay head `1f9cffa3a7f1ca59a672461f197088a36d917e1d` is Draft/HOLD after a separate Cloud Classroom 10,000-rule test timed out. Both Node 18/20 TM acceptance steps passed. Recovery product code is unchanged. | Resolve the cross-domain CI failure with evidence, obtain clean exact-head checks and separate merge authorization for #6059, then verify merged-main acceptance with zero persistent owned-DB residue. A successful retry alone is not closure. |
