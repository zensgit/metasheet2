...
| 备料 / K3 首 profile | **功能已落尽** | 见 §6 工作分解(#4768 已 armed;另有 #4787/#4785 两份文档票) | 我方(今日可清) |
...
**#4768 — staging 窗口彩排**(**已 Ready 并 armed**;#4784 已合,本分支 rebase 其上,经四轮独立门审,末轮判无 P1 无 P2)。让 runbook 对着真实部署包整条跑一遍。
...
```
#4784 已合 ──► #4768 已 rebase ──► 四轮门审(末轮无 P1 无 P2) ──► Ready/armed ──► 合并 ──► dispatch 彩排
   ✅              ✅                  ✅                        ✅           自动      合并后立即
                                                                            │
                                                                                      ▼
                                                        ┌───────────────────────────────────┐
...
| 彩排跑绿后的验收 MD 回填 | **fable 5** | 形状固定,填实测值 —— **尚无实测值,故本轮未派** |
...
| #4768 彩排 lane(含 B4 D1 闭合、迁移名单精确校验、谓词守卫 v3) | #4784 | 我方 | Ready 并 armed,四轮门审最终判无 P1 无 P2 |
| #4787 窗口自检下界上移 + 文档状态清扫 | — | 我方 | 已开 PR,待合 |
