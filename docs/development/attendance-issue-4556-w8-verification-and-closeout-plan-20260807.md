...
> `origin/main@a1a853b5ac687d35e95eba94b3b421b082fb06ef`.
...
- L8 wiring evidence — **the gap this evidence chain tracked is now closed**
  ...
  `~L1237` at the current tip); the **facts**, re-counted at `a1a853b5`: 40
...
`a95472ac7b99a9c8de52376a922ec6bda7f025cb` — see ledger row L11. The prior
head `dcc4214efa571c8bb6e1706d31cb390bb7daa785` completed its exact-head
checks and review; that evidence is historical and does not transfer. The
