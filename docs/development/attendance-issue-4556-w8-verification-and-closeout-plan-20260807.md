...
> `origin/main@a87fb7e581007a5711a43ead7c85db87ffe69cce`.
...
- L8 wiring evidence — **the gap this evidence chain tracked is now closed**
  ...
  core-backend tests", no `DATABASE_URL`, `~L636` at the current tip — this
  ...
  `~L1237` at the current tip); the **facts**, re-counted at `a87fb7e5`: 40
...
`dcc4214efa571c8bb6e1706d31cb390bb7daa785` — see ledger row L11. The prior
head's exact-head evidence is historical and does not transfer; the current
head requires fresh checks and independent review before landing. Naming it
