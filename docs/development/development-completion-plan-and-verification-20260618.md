...
- **2026-06-21 钉钉手册复核候选** — 已记录到 `attendance-dingtalk-benchmark-target-and-tracker-20260601.md` §0.5（通知渠道扩展、员工自助统一入口、补卡规则/异常处理台、报表运营台、假期类型泛化、多时区报表等）；这些是 future gated candidates，**不是已授权剩余开发**。
