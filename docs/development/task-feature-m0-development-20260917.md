...
- head SHA：内容 SHA `85aa8f95cf570ec00c0fa0a16217105e1fb92291`（闸 §12 第八轮；merge-base `bb77ca5f2ce3c2825265ec8877861d367d017ead`；本轮不 rebase）。若其后有 SHA-record 提交，末次仅回填本行。
