...
- head SHA：内容 SHA `ee370ceb81448360ae670cd0941b043fff54b46e`（闸 §17 第十三轮；merge-base `bb77ca5f2ce3c2825265ec8877861d367d017ead`；本轮不 rebase）。若其后有 SHA-record 提交，末次仅回填本行。
