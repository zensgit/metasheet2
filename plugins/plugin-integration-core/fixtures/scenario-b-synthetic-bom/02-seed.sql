...
INSERT INTO syn_bom_items (line_no, project_no, parent_no, part_no, part_name, qty, uom, rev, level_no, path_key) VALUES
  ...
  (4, 'SYN-PRJ-B1', 'SYN-SUB-01', 'SYN-PRT-01-03', '合成零件 1-3', 5, 'SET', 'B3', 2, '/SYN-ASM-ROOT/SYN-SUB-01/SYN-PRT-01-03'),
  ...
  (15, 'SYN-PRJ-B1', 'SYN-SUB-02', 'SYN-PRT-02-05', '合成零件 2-5', 5, 'SET', 'B1', 2, '/SYN-ASM-ROOT/SYN-SUB-02/SYN-PRT-02-05'),
  ...
  (36, 'SYN-PRJ-B1', 'SYN-SUB-04', 'SYN-PRT-04-08', '合成零件 4-8', 6, 'PCS', 'B0', 2, '/SYN-ASM-ROOT/SYN-SUB-04/SYN-PRT-04-08'),
