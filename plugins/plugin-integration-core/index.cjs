...
const { createBridgeAgentReadonlyAdapterFactory } = require('./lib/adapters/bridge-agent-readonly-adapter.cjs')
...
const { createDataSourceSqlWriteGatedTargetAdapterFactory } = require('./lib/adapters/data-source-sql-write-gated-target-adapter.cjs')
...
module.exports = {
  async activate(context) {
    ...
    adapterRegistry = createAdapterRegistry({ logger })
      ...
      .registerAdapter('bridge:legacy-sql-readonly', createBridgeAgentReadonlyAdapterFactory())
      ...
      .registerAdapter('data-source:sql-readonly', createDataSourceSqlReadonlySourceAdapterFactory({ context }))
      .registerAdapter('data-source:sql-write-gated', createDataSourceSqlWriteGatedTargetAdapterFactory({ context }))
