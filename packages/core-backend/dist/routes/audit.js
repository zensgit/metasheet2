 ...
 */
router.get('/audit/users/:userId/activity', async (req, res) => {
    try {
 ...
 */
router.get('/audit/security/summary', async (req, res) => {
    try {
...
router.post('/audit/export', async (req, res) => {
    try {
        ...
        await auditService.logEvent('EXPORT', 'Export audit logs', {
            eventCategory: 'DATA',
...
function getTopItems(array, key, limit) {
