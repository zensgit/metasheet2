...
export function createGateway(app, preset = 'moderate') {
...
export function createCRUDEndpoints(resource, options = {}) {
    const base = {
...
export function registerBulkEndpoints(gateway, endpoints) {
