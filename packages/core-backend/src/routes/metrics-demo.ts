...
router.get(
  '/api/spreadsheets/:id',
  PermissionMetricsMiddleware.validateToken,
  PermissionMetricsMiddleware.checkPermission('spreadsheet:read'),
  (req, res) => {
    res.json({
      id: req.params.id,
...
router.put(
  '/api/spreadsheets/:id',
  PermissionMetricsMiddleware.validateToken,
  PermissionMetricsMiddleware.checkPermission('spreadsheet:write'),
  (req, res) => {
    res.json({
      id: req.params.id,
...
router.post(
  '/api/workflows',
  PermissionMetricsMiddleware.validateToken,
  PermissionMetricsMiddleware.checkPermission('workflow:create'),
  (req, res) => {
    res.status(201).json({
      id: 'wf-' + Date.now(),
 ...
 */
router.get(
  '/api/approvals/finance',
  PermissionMetricsMiddleware.validateToken,
  PermissionMetricsMiddleware.checkDepartmentAccess(['finance', 'admin']),
  (req, res) => {
    res.json({
      approvals: [
