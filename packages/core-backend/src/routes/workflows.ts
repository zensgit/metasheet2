...
// Publish workflow
router.post('/workflows/:id/publish', authMiddleware, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id
...
// Execute workflow
router.post('/workflows/:id/execute', authMiddleware, async (req: Request, res: Response) => {
  try {
...
router.get('/workflows/:id/instances', authMiddleware, async (req: Request, res: Response) => {
  try {
...
router.get('/instances/:id', authMiddleware, async (req: Request, res: Response) => {
  try {
    const instance = await db
      .selectFrom('workflow_instances')
      .selectAll()
...
router.post('/instances/:id/cancel', authMiddleware, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id
