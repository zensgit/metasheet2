export interface SecurityPolicyOptions {
  ...
  maxCPU?: number // Maximum CPU time in seconds
  ...
  allowChildProcess?: boolean // Allow spawning child processes
  ...
  blockedAPIs?: string[] // Blacklist of blocked APIs
  allowedDomains?: string[] // Whitelist of allowed network domains
  blockedDomains?: string[] // Blacklist of blocked network domains
  maxLoops?: number // Maximum number of loop iterations
  maxRecursion?: number // Maximum recursion depth
...
export class SecurityPolicy {
  ...
  generateSafeWrapper(script: string, language: 'javascript' | 'python' = 'javascript'): string {
