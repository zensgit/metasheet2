/**
 * Migration: `write_approval_form_values` automation action (FWB D11) — widen the
 * action_type CHECK constraint so approval.completed rules can persist the dedicated
 * form-writeback action. Pure DDL; idempotent. Does NOT enable any FWB/durable flag.
 */
