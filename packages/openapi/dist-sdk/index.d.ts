...
export interface paths {
    ...
    "/api/elearning/admin/offline-trainings": {
        ...
        put?: never;
        /**
         * Publish one immutable offline training revision and its member roster
         ...
         *     `ELEARNING_OFFLINE_TRAINING_ENABLED=true`. The closed command never accepts organization or
         *     actor identifiers. A same-request replay returns the original result; a different payload
         *     under the same request id returns a values-free conflict.
         */
        post: operations["publishElearningOfflineTraining"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/elearning/admin/offline-trainings/{trainingId}/targets/{targetId}/qr": {
        ...
        put?: never;
        /**
         * Issue one short-lived QR challenge for a training target
         * @description Rechecks the same server-derived organization, actor, global-admin, `elearning:admin`, and
         *     exact feature gates as publish. Path identifiers are authoritative; the closed body contains
         *     only requestId and action. The signed token is opaque to clients and expires after the
         *     server-defined short window.
         */
        post: operations["issueElearningOfflineTrainingQr"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/elearning/me/offline-attendance": {
        ...
        put?: never;
        /**
         * Record one authenticated learner check-in or check-out from an opaque QR token
         * @description Requires server-derived organization and learner identity, learner read authority, and exact
         *     master plus offline-training gates. The server verifies token signature, expiry, active
         *     membership, target window, and check-in-before-check-out ordering. Responses and errors never
         *     expose signing material, token claims, request hashes, or organization identifiers.
         */
        post: operations["recordElearningOfflineAttendance"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ElearningOfflineTarget: {
            targetId: components["schemas"]["ElearningUuid"];
            position: number;
            title: string;
            /** Format: date-time */
            startsAt: string;
        ...
        ElearningOfflineQrIssueRequest: {
            requestId: components["schemas"]["ElearningUuid"];
            action: components["schemas"]["ElearningOfflineAttendanceAction"];
        };
        ...
        ElearningOfflineAttendanceResult: {
            eventId: components["schemas"]["ElearningUuid"];
            trainingId: components["schemas"]["ElearningUuid"];
            revisionId: components["schemas"]["ElearningUuid"];
            targetId: components["schemas"]["ElearningUuid"];
            action: components["schemas"]["ElearningOfflineAttendanceAction"];
        ...
        ElearningOfflineLearnerTrainingList: {
            trainings: components["schemas"]["ElearningOfflineLearnerTraining"][];
        };
    };
    responses: {
...
export interface operations {
    ...
    publishElearningOfflineTraining: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ElearningOfflineTrainingPublishRequest"];
            };
        };
        responses: {
            /** @description Idempotent replay of the original publish result. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Offline training published. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    issueElearningOfflineTrainingQr: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ElearningOfflineQrIssueRequest"];
            };
        };
        responses: {
            /** @description Idempotent replay of the original QR result. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ElearningOfflineQrResult"];
                };
            };
            /** @description QR challenge issued. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    recordElearningOfflineAttendance: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ElearningOfflineAttendanceRequest"];
            };
        };
        responses: {
            /** @description Attendance effect or idempotent replay result. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listMyElearningOfflineTrainings: {
        ...
        requestBody?: never;
        responses: {
            /** @description Closed learner offline-training list. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ElearningOfflineLearnerTrainingList"];
                };
            };
            401: components["responses"]["ElearningAuthError"];
            403: components["responses"]["ElearningError"];
